...
class CycleGANModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.add_argument('--direction', type=str, default='AtoB', help='Direction of image translation')
        if is_train:
            parser.add_argument('--amp', type=bool, default=False, help='loss scale')
