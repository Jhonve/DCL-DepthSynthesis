...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--name', type=str, default='horse2zebracutinori', help='name of the experiment. It decides where to store samples and models')
        ...
        # dataset parameters
        parser.add_argument('--dataset', type=str, default='horse2zebra', choices=['depthsynthesis', 'horse2zebra', 'apple2orange'], help='choose whihc dataset to train.')
        parser.add_argument('--data_path_prepared', type=bool, default=True, help='Wherether to generate depth path file.')
        parser.add_argument('--noise_depth_max', type=int, default=None, help='8000 depth scale of synthetic depth data. If none, use max.')
        parser.add_argument('--noise_depth_min', type=int, default=None, help='264 depth scale of real-scan depth data. If none, use max.')
        ...
        parser.add_argument('--data_path_image', type=str, default='../../Dataset/ImageTasksDatasets/', help='Path to image task dataset')
        parser.add_argument('--data_path_h5', type=str, default='./datasets/', help='Path to h5 file for saving data pathes')
        parser.add_argument('--zoom_out_scale', type=int, default=0, help='Doing scaling in the training step')
        parser.add_argument('--fixed_scale', type=int, default=256, help='The fixed size in the training step')
        ...
        parser.add_argument('--use_rgb', type=bool, default=False, help='if specified, print more debugging information')
